...
# SO HERE IS THE PLAN:
  # STEP 1: I CAN SOLVE THE DEV CONSOLE PROBLEM BY MAKING
  # A MODULE THAT STORES THA VALUES THAT ARE THEN CALLED BY
  # THE RESPECTIVE FUNCTIONS

  # STEP 2: I CAN ISOLATE THE WINDOW FUNCTIONS INTO INDIVIDUAL
  # CLASSES WHICH CAN THEN GET CALLED IN THE MAIN FUNCTION HERE
    # SUB-STEP 3:
    # I CAN DO ALL THE INITIALIZATION IN THE CLASS
